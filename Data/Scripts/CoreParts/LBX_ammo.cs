    ...
    partial class Parts
    {
        ...
        private AmmoDef LBX5_HighExplosive => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                Fragments = 37, // Cone in which to randomize direction of spawned projectiles.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    GroupSize = 37, // Number of spawns in each group
        ...
        private AmmoDef Frag_LBX5_HighExplosive => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = true, // fragments will not inherit velocity from parent.
                Offset = -4f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards), value is read from parent ammo type.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    GroupDelay = 20, // Delay between each group.
                },
            },
            Pattern = new PatternDef
            {
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
    {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    Aggressiveness = 0f, // controls how responsive tracking is.
                    MaxLateralThrust = 0, // controls how sharp the trajectile may turn
                    TrackingDelay = 1000000, // Measured in Shape diameter units traveled.
                    MaxChaseTime = 0, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = false, // when set to true ammo picks its own target, does not use hardpoint's.
                    CheckFutureIntersection = false, // Utilize obstacle avoidance for drones
                    MaxTargets = 0, // Number of targets allowed before ending, 0 = unlimited
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
{
        ...
        private AmmoDef LBX5_Cluster => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "Cluster Shot", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                DropVelocity = false, // fragments will not inherit velocity from parent.
                Offset = 0f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards), value is read from parent ammo type.
                Radial = 0.5f, // Determines starting angle for Degrees of spread above.  IE, 0 degrees and 90 radial goes perpendicular to travel path
                MaxChildren = 0, // number of maximum branches for fragments from the roots point of view, 0 is unlimited
                IgnoreArming = true, // If true, ignore ArmOnHit or MinArmingTime in EndOfLife definitions
                AdvOffset = Vector(x: 0, y: 0, z: 0), // advanced offsets the fragment by xyz coordinates relative to parent, value is read from fragment ammo type.
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
        ...
        private AmmoDef LBX5_Cluster_Canister => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                Degrees = 4f, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = true, // fragments will not inherit velocity from parent.
                Offset = -10f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards), value is read from parent ammo type.
                Radial = 0f, // Determines starting angle for Degrees of spread above.  IE, 0 degrees and 90 radial goes perpendicular to travel path
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    Proximity = 1050, // Starting distance from target bounding sphere to start spawning fragments, 0 disables this feature.  No spawning outside this distance
                    ParentDies = true, // Parent dies once after it spawns its last child.
                    PointAtTarget = true, // Start fragment direction pointing at Target
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 20, green: 20, blue: 30, alpha: 0.5f),
                        Back = false,
                        CustomWidth = 1f,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef Frag_LBX5_Cluster => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 41000f, // Direct damage; one steel plate is worth 100.
            Mass = 100f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 0f, // Recoil. This is applied to the Parent Grid.
            DecayPerShot = 0f, // Damage to the firing weapon itself.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Shields = new ShieldDef
                {
                    Modifier = 9.5f, // Multiplier for damage against shields.
                    Type = Default, // Damage vs healing against shields; Default, Heal
                    BypassModifier = -1f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
                DamageType = new DamageTypes // Damage type of each element of the projectile's damage; Kinetic, Energy
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 12000, // Max Distance the projectile or beam can Travel.
        ...
        private AmmoDef Fixed4LBX5_Cluster => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "LBX5_Cluster", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
